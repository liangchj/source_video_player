...
import 'package:source_video_player/pages/full_screen_play_page.dart';
...
class AppPages {
  static final pages = [
    ...
    GetPage(
        name: AppRoutes.fullScreenPlayPage,
        page: () => const FullScreenPlayPage(),
        binding: BindingsBuilder(() => Get.lazyPut(() => PlayController()))),
  ];
}
